...
// import "./Header.scss";
// import { FaShoppingBag,FaHome, FaInfoCircle, FaBoxOpen, FaPhoneAlt, FaBars, FaTimes } from "react-icons/fa";
...
//           </li>
//           <li>
//             <a href="#services"><FaBoxOpen className="nav-icon" />Products</a>
//           </li>
//           <li>
